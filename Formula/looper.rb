class Looper < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/program247365/looper/releases/download/v0.13.3/looper-aarch64-apple-darwin.tar.gz"
      sha256 "a26a8e75633ddfccd160b10fcc20a60a840b5a8e6930c172d53657bf41fe1fcf"
    end
  end
