class Looper < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/program247365/looper/releases/download/v0.10.0/looper-aarch64-apple-darwin.tar.gz"
      sha256 "9634040d4b584c78d5b1cd5e9116ebc21d05029632096e0fd79728919912a369"
    end
  end
